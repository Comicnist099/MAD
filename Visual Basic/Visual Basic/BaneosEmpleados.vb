Public Class BaneosEmpleados
    Private Sub BaneosEmpleados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim Enlace As New EnlaceBD
        Dim clientes As New DataTable
        clientes = Enlace.getTODOSEmpleados()
    ...
    Private Sub BtnBaneado_Click(sender As Object, e As EventArgs) Handles BtnBaneado.Click
        ...
        Dim id_Empleados2 As Integer = Enlace.GetIdUsuario(Nombre)
        clientes2 = Enlace.getRol(id_Empleados2)

        Dim tempcliente As DataRow = clientes2.Rows.Item(cont2 - 1)


        If tempcliente("Rol").ToString() = "Admin" Then
            MessageBox.Show("No se pueden banear los admins", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)

        Else

            Enlace.DesabilitarEmpleados(Nombre)
            TextEstado.Text = tempcliente2("Estado").ToString()
        End If
    ...
    Private Sub BrnDesvanear_Click(sender As Object, e As EventArgs) Handles BrnDesvanear.Click
        ...
        Enlace.HabilitarEmpleado(Nombre)
        TextEstado.Text = tempcliente2("Estado").ToString()
    End Sub
    ...
    Private Sub TextEstado_TextChanged(sender As Object, e As EventArgs) Handles TextEstado.TextChanged
